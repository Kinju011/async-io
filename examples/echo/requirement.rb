...
def config
  ...
  server_endpoint = Async::IO::SSLEndpoint.new(endpoint, ssl_context: verified_contexts[0], timeout: 20)
  client_endpoint = Async::IO::SSLEndpoint.new(endpoint, ssl_context: verified_contexts[1], timeout: 20)
